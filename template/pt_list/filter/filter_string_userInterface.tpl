...
{/if}
	<input class="tx_ptgsaconfmgm_text" type="text" name="{$prefixId}[value]" value="{$value}" />
	
	<input class="tx_ptgsaconfmgm_button" type="submit" value="{$filterconf.submitValue|ll:0}" />
</form>
