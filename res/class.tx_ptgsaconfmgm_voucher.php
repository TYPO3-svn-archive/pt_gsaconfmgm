 ...
 *
 * $Id: class.tx_ptgsaconfmgm_voucher.php,v 1.1 2009/07/03 11:36:16 ry25 Exp $
 *
 ...
 */
require_once t3lib_extMgm::extPath('pt_gsaconfmgm').'res/class.tx_ptgsaconfmgm_voucherAccessor.php';  // extension specific database accessor class for voucher data
 ...
 */
class tx_ptgsaconfmgm_voucher  {
    
    /**
     * Constants
     */

    const EXTKEY = 'tx_ptgsaconfmgm';
    ...
    protected $orderArticleUid;			// integer id of the order article
    ...
    public function __construct($voucherId=0, $voucherCode='') {
        ...
        if ($voucherId  > 0) {
            $voucherDataArr = tx_ptgsaconfmgm_voucherAccessor::getInstance()->selectVoucherByUid($voucherId);
        }
        
        if ($voucherCode  != '') {
            $voucherDataArr = tx_ptgsaconfmgm_voucherAccessor::getInstance()->selectVoucherByCode($voucherCode);
        }
    ...
    public function storeSelf() {
        ...
        $this->set_uid(tx_ptgsaconfmgm_voucherAccessor::getInstance()->storeVoucherData($dataArray));
    ...
    public function createCode($id = 0) {
		...
		while ($cnt < 10) {
			...
			$checkArray = tx_ptgsaconfmgm_voucherAccessor::getInstance()->selectVoucherByCode($candidate);
    ...
    */
    ...
    public function set_orderArticleUid($uid) {
    	$this->orderArticleUid = $uid;
    }

    public function get_orderArticleUid() {
    	return $this->orderArticleUid;
    }
    ...
    */
    public function set_isEncashed($isEncashed) {
        $this->isEncashed = $isEncashed ? true : false;
    }
