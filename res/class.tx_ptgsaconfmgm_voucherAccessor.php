 ...
 *
 * $Id: class.tx_ptgsaconfmgm_voucherAccessor.php,v 1.1 2009/07/03 11:36:16 ry25 Exp $
 *
 ...
 */
class tx_ptgsaconfmgm_voucherAccessor  implements tx_pttools_iSingleton {
    /*
     * Contansts
     */
    const DB_TABLE = 'tx_ptgsaconfmgm_voucher';
    ...
    public function storeVoucherData($dataArr) {
        ...
        $row = array (
               ...
               'order_article_uid' => intval($dataArr['orderArticleUid']),
