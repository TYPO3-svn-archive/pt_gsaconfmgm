...
class tx_ptgsaconfmgm_eventAccessor implements tx_pttools_iSingleton {
    ...
    public function selectAll() {
        ...
        $select  = 'uid, title, description, venue';
        $from    = 'tx_ptconference_domain_model_event events';
        $where   = '';
        $groupBy = '';
        $orderBy = 'title';
        $limit   = '';
    ...
    public function getTitleList() {
    	$eventArray = $this->selectAll();
    	$titleList = array();
    	
    	foreach($eventArray as $uid => $event) {
    		$titleList[$uid] = $event['title'];
    	}
